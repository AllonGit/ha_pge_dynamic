# custom_components/pge_dynamic/api.py
...
class PGEApiClient:
    ...
    async def async_get_prices(self, for_date: datetime.date):
        """Pobiera ceny energii dla określonej daty."""
        date_str = for_date.strftime("%Y-%m-%d")
        # Zgodnie z logiką API, aby dostać dane na 'dziś', pytamy o 'wczoraj'.
